...
interface FitoutFinancingExistingProps {
  data: {
...
export function FitoutFinancingExisting({ data, period, onUpdate }: FitoutFinancingExistingProps) {
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader className="bg-muted rounded-t-lg">
          <CardTitle>Setup Costs - Purchase Existing</CardTitle>
        ...
        <CardContent className="pt-6 space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <Input
                ...
                type="text"
                className="pl-7"
                value={formatInputCurrency(data.purchasePrice || 0)}
                onChange={(e) => handleCurrencyChange('purchasePrice', e.target.value)}
              />
            </div>
          </div>
          <div>
            <Label htmlFor="equipment">New Equipment</Label>
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground">$</span>
              <Input
                id="equipment"
          ...
          <div>
            <Label htmlFor="furniture">New Furniture & Fittings</Label>
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground">$</span>
              <Input
                id="furniture"
          ...
          <div>
            <Label htmlFor="tech">New Tech & POS</Label>
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground">$</span>
              <Input
                id="tech"
          ...
          <div>
            <Label htmlFor="stock">New Initial Stock</Label>
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground">$</span>
              <Input
                id="stock"
          ...
          <div>
            <Label htmlFor="fitout">New Fitout & Signage Upgrades</Label>
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground">$</span>
              <Input
                id="fitout"
          ...
          <div>
            <Label htmlFor="designFees">New Design Fees</Label>
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground">$</span>
              <Input
                id="designFees"
          ...
          <div>
            <Label htmlFor="legal">New Legal & Licenses</Label>
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground">$</span>
              <Input
                id="legal"
          ...
          <div>
            <Label htmlFor="operatingCapital">New Operating Capital Reserve</Label>
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground">$</span>
              <Input
                id="operatingCapital"
